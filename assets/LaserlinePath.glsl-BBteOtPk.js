import{l8 as be,nz as we,qO as De,FP as f,qF as w,qL as Ve,qv as B,Jz as r,tl as z,Hu as ee,CR as xe,qC as y,mo as te,jw as A,kd as W,qP as Le,Df as ie,FV as ne,qA as S,h5 as _,BP as v,OB as se,B4 as ae,zU as o,KI as re,i3 as Ee,H as ye,fV as Se,po as le,A7 as oe,LV as Ce,JF as Me,vg as Ae,JC as $e,qG as Re,Bm as H,py as Te,os as ce,IY as he,jX as de,mx as Oe,EV as G,M1 as q,jU as c,me as j,IB as pe,gk as ue,pn as Ie,Kl as I,jC as Ue,FS as qe,F0 as ze,l9 as je,vC as V,KO as Ne,hE as k,HT as Fe,F4 as Be,E4 as $,CT as We,bi as J,z8 as He,M9 as Ge,fD as ke,Dz as Je,lN as Ke,v0 as Xe,k0 as C,l$ as Qe,IO as K}from"./index-B_o9Xx8I.js";import{t as Ye}from"./VisualElement-DXDaer_d.js";function fe(t,e){const n=t.fragment;n.include(be),t.include(we),n.include(De),n.uniforms.add(new f("globalAlpha",i=>i.globalAlpha),new w("glowColor",i=>i.glowColor),new f("glowWidth",(i,s)=>i.glowWidth*s.camera.pixelRatio),new f("glowFalloff",i=>i.glowFalloff),new w("innerColor",i=>i.innerColor),new f("innerWidth",(i,s)=>i.innerWidth*s.camera.pixelRatio),new Ve("depthMap",i=>i.depth?.attachment),new B("normalMap",i=>i.normals)),n.code.add(r`vec4 premultipliedColor(vec3 rgb, float alpha) {
...
return abs(dist);
}`),t.spherical){const i=(a,l,p)=>_(a,l.heightManifoldTarget,p.camera.viewMatrix),s=(a,l)=>_(a,[0,0,0],l.camera.viewMatrix);n.uniforms.add(new y("heightManifoldOrigin",(a,l)=>(i(u,a,l),s(D,l),te(D,D,u),A(d,D),d[3]=W(D),d)),new Le("globalOrigin",a=>s(u,a)),new f("cosSphericalAngleThreshold",(a,l)=>1-Math.max(2,ie(l.camera.eye,a.heightManifoldTarget)*l.camera.perRenderPixelRatio)/W(a.heightManifoldTarget))),n.code.add(r`float globeDistancePixels(float posInGlobalOriginLength) {
