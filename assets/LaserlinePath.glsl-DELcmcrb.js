import{j$ as be,mi as we,po as De,DX as f,pf as w,pl as Ve,p5 as W,HB as r,rI as z,Fy as ee,B6 as xe,pc as L,l9 as te,ij as A,j2 as H,pp as ye,Bw as ie,E1 as ne,pa as S,gc as m,A3 as v,Mv as se,zj as ae,y9 as o,IG as re,g_ as Ee,H as Le,fc as Se,nY as le,yn as oe,JS as Ce,HH as Me,tF as Ae,HE as $e,pg as Re,zC as F,o6 as Te,n1 as ce,G_ as he,iM as de,li as Oe,D1 as G,J_ as j,iJ as c,k$ as q,GD as pe,fy as ue,nX as Ie,Il as I,iq as Ue,D_ as je,D8 as ze,k0 as qe,u0 as V,IM as Ne,gG as k,FY as Be,Dc as We,Ch as $,B8 as He,aY as X,xp as Fe,K6 as Ge,eX as ke,BN as Xe,kA as Je,tp as Qe,iQ as C,kN as Ye,GQ as J}from"./index-BwqLBZ2z.js";import{t as Ke}from"./VisualElement-Bm3Vo2dk.js";function fe(t,e){const n=t.fragment;n.include(be),t.include(we),n.include(De),n.uniforms.add(new f("globalAlpha",i=>i.globalAlpha),new w("glowColor",i=>i.glowColor),new f("glowWidth",(i,s)=>i.glowWidth*s.camera.pixelRatio),new f("glowFalloff",i=>i.glowFalloff),new w("innerColor",i=>i.innerColor),new f("innerWidth",(i,s)=>i.innerWidth*s.camera.pixelRatio),new Ve("depthMap",i=>i.depth?.attachment),new W("normalMap",i=>i.normals)),n.code.add(r`vec4 premultipliedColor(vec3 rgb, float alpha) {
...
return abs(dist);
}`),t.spherical){const i=(a,l,p)=>m(a,l.heightManifoldTarget,p.camera.viewMatrix),s=(a,l)=>m(a,[0,0,0],l.camera.viewMatrix);n.uniforms.add(new L("heightManifoldOrigin",(a,l)=>(i(u,a,l),s(D,l),te(D,D,u),A(d,D),d[3]=H(D),d)),new ye("globalOrigin",a=>s(u,a)),new f("cosSphericalAngleThreshold",(a,l)=>1-Math.max(2,ie(l.camera.eye,a.heightManifoldTarget)*l.camera.perRenderPixelRatio)/H(a.heightManifoldTarget))),n.code.add(r`float globeDistancePixels(float posInGlobalOriginLength) {
...
vec4 color = vec4(0.0);`),t.heightManifoldEnabled){n.uniforms.add(new S("angleCutoff",s=>M(s)),new L("heightPlane",(s,a)=>_e(s.heightManifoldTarget,s.renderCoordsHelper.worldUpAtPosition(s.heightManifoldTarget,u),a.camera.viewMatrix)));const i=t.spherical?r`normalize(globalOrigin - pos)`:r`heightPlane.xyz`;n.main.add(r`
      ...
      color = max(color, heightManifoldColor * heightManifoldAlpha);`)}return t.pointDistanceEnabled&&(n.uniforms.add(new S("angleCutoff",i=>M(i)),new L("pointDistanceSphere",(i,s)=>Ze(i,s))),n.main.add(r`float pointDistanceSphereDistance = sphereDistancePixels(pointDistanceSphere, pos);
...
}`)),t.intersectsLineEnabled&&(n.uniforms.add(new S("angleCutoff",i=>M(i)),new w("intersectsLineStart",(i,s)=>m(u,i.lineStartWorld,s.camera.viewMatrix)),new w("intersectsLineEnd",(i,s)=>m(u,i.lineEndWorld,s.camera.viewMatrix)),new w("intersectsLineDirection",(i,s)=>(v(d,i.intersectsLineSegment.vector),d[3]=0,A(u,se(d,d,s.camera.viewMatrix)))),new f("intersectsLineRadius",i=>i.intersectsLineRadius)),n.main.add(r`if (pointIsWithinLine(pos, intersectsLineStart, intersectsLineEnd)) {
float intersectsLineDistance = lineDistancePixels(intersectsLineStart, intersectsLineDirection, intersectsLineRadius, pos);
vec4 intersectsLineColor = laserlineProfile(intersectsLineDistance);
float intersectsLineAlpha = 1.0 - smoothstep(angleCutoff.x, angleCutoff.y, 1.0 - abs(dot(normal, intersectsLineDirection)));
color = max(color, intersectsLineColor * intersectsLineAlpha);
}`)),n.main.add(r`fragColor = laserlineOutput(color * depthDiscontinuityAlpha);`),e}function M(t){return re(nt,Math.cos(t.angleCutoff),Math.cos(Math.max(0,t.angleCutoff-z(2))))}function Ze(t,e){return m(U,t.pointDistanceOrigin,e.camera.viewMatrix),U[3]=ie(t.pointDistanceOrigin,t.pointDistanceTarget),U}function et(t,e){const n=Le(t.lineVerticalPlaneSegment,.5,u),i=t.renderCoordsHelper.worldUpAtPosition(n,st),s=A(D,t.lineVerticalPlaneSegment.vector),a=Se(u,i,s);return A(a,a),_e(t.lineVerticalPlaneSegment.origin,a,e.camera.viewMatrix)}function tt(t,e){const n=v(u,t.lineVerticalPlaneSegment.origin);return t.renderCoordsHelper.setAltitude(n,0),m(n,n,e.camera.viewMatrix)}function it(t,e){const n=le(u,t.lineVerticalPlaneSegment.origin,t.lineVerticalPlaneSegment.vector);return t.renderCoordsHelper.setAltitude(n,0),m(n,n,e.camera.viewMatrix)}function _e(t,e,n){return m(Q,t,n),v(d,e),d[3]=0,se(d,d,n),Ee(Q,d,at)}const nt=oe(),u=o(),d=ae(),st=o(),D=o(),Q=o(),at=Ce(),U=ae(),rt=Object.freeze(Object.defineProperty({__proto__:null,build:ge,defaultAngleCutoff:N},Symbol.toStringTag,{value:"Module"}));function me(t){const e=new ee;e.include(fe,t);const{vertex:n,fragment:i}=e;n.uniforms.add(new Me("modelView",(a,{camera:l})=>Ae(ot,l.viewMatrix,a.origin)),new $e("proj",({camera:a})=>a.projectionMatrix),new f("glowWidth",(a,{camera:l})=>a.glowWidth*l.pixelRatio),new Re("pixelToNDC",({camera:a})=>re(lt,2/a.fullViewport[2],2/a.fullViewport[3]))),e.attributes.add("start","vec3"),e.attributes.add("end","vec3"),t.spherical&&(e.attributes.add("startUp","vec3"),e.attributes.add("endUp","vec3")),e.attributes.add("extrude","vec2"),e.varyings.add("uv","vec2"),e.varyings.add("vViewStart","vec3"),e.varyings.add("vViewEnd","vec3"),e.varyings.add("vViewSegmentNormal","vec3"),e.varyings.add("vViewStartNormal","vec3"),e.varyings.add("vViewEndNormal","vec3");const s=!t.spherical;return n.main.add(r`
