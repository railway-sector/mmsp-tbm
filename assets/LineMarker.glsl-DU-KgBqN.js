import{GI as ee,rh as te,uw as ie,us as re,rd as ae,pV as se,pW as oe,IJ as o,D3 as ne,IP as ce,F7 as le,Ae as _,LY as pe,pX as de,H3 as N,s_ as he,pL as ve,pM as ue,pR as me,pN as fe,ux as R,oj as E,Ai as ge,kG as Se,of as Pe,fZ as ye,rZ as we,HP as _e,IK as xe,jA as ze,LV as L,IL as U,mZ as $e,re as B,KA as M,rg as be,s$ as Te,xp as ke,BI as Ve,BJ as k,rf as Oe,pY as De,Aj as q,kH as H,KD as We,uy as Ce,kI as Le,jx as c,lK as Me,F1 as Ae,uu as d,jO as Fe,kC as je,Mw as K,Bg as Ie,F5 as Ne,IQ as Re,IM as Ee,Jv as Y,bU as Ue,bt as G,yT as J,Mx as Be}from"./index-t9xTnnrs.js";function Z(t){const e=new ee,{space:r,anchor:i,hasTip:P,hasScreenSizePerspective:x}=t,u=r===2,g=r===1;e.include(te,t),e.include(ie,t),e.include(re,t);const{vertex:a,fragment:S,varyings:y}=e;ae(a,t),e.attributes.add("position","vec3"),e.attributes.add("previousDelta","vec4"),e.attributes.add("uv0","vec2"),y.add("vColor","vec4"),y.add("vpos","vec3",{invariant:!0}),y.add("vUV","vec2"),y.add("vSize","float"),P&&y.add("vLineWidth","float"),a.uniforms.add(new se("nearFar",({camera:p})=>p.nearFar),new oe("viewport",({camera:p})=>p.fullViewport)).code.add(o`vec4 projectAndScale(vec4 pos) {
...
return abs(cos) > 0.001 && t > 0.0;
  ...
  `)),pe(a),e.include(de),a.main.add(o`
    ...
    if (uv0.y == 0.0) {
      ...
      float lineWidth = getLineWidth(${_(x,"pos.xyz")});
...
return clamp(0.5 - pixelDistance, 0.0, 1.0);
}`),P&&(e.include(E),S.constants.add("relativeMarkerSize","float",ge/R).constants.add("relativeTipLineWidth","float",Se).code.add(o`
  ...
  `)),e.include(Pe,t),e.include(E),S.main.add(o`
    ...
    outputColorHighlightOLID(applySlice(finalColor, vpos), finalColor.rgb);`),e}const qe=Object.freeze(Object.defineProperty({__proto__:null,build:Z},Symbol.toStringTag,{value:"Module"}));let A=class extends we{constructor(t,e){super(t,e,_e(Q(e))),this.shader=new xe(qe,()=>ze(()=>Promise.resolve().then(()=>Ze),void 0))}_makePipelineState(t,e){const{output:r,hasEmission:i,oitPass:P,space:x,hasOccludees:u}=t;return L({blending:k(r)?Oe(P):null,depthTest:x===0?null:Ve(P),depthWrite:ke(t),drawBuffers:be(r,Te(P,i)),colorWrite:M,stencilWrite:u?B:null,stencilTest:u?e?U:$e:null,polygonOffset:{factor:0,units:-10}})}initializePipeline(t){return t.occluder?(this._occluderPipelineTransparent=L({blending:H,depthTest:q,depthWrite:null,colorWrite:M,stencilWrite:null,stencilTest:De}),this._occluderPipelineOpaque=L({blending:H,depthTest:q,depthWrite:null,colorWrite:M,stencilWrite:Ce,stencilTest:We}),this._occluderPipelineMaskWrite=L({blending:null,depthTest:Le,depthWrite:null,colorWrite:null,stencilWrite:B,stencilTest:U})):this._occluderPipelineTransparent=this._occluderPipelineOpaque=this._occluderPipelineMaskWrite=null,this._occludeePipelineState=this._makePipelineState(t,!0),this._makePipelineState(t,!1)}getPipeline(t,e){return e?this._occludeePipelineState:t.occluder===12?this._occluderPipelineTransparent??super.getPipeline(t):t.occluder===11?this._occluderPipelineOpaque??super.getPipeline(t):this._occluderPipelineMaskWrite??super.getPipeline(t)}};function Q(t){const e=ye().vec3f("position").vec4f16("previousDelta").vec2f16("uv0");return t.hasVVColor?e.f32("colorFeatureAttribute"):e.vec4u8("color",{glNormalized:!0}),t.hasVVOpacity&&e.f32("opacityFeatureAttribute"),t.hasVVSize?e.f32("sizeFeatureAttribute"):e.f16("size"),t.worldSpace&&e.vec3f16("normal"),e.freeze()}A=c([Me("esri.views.3d.webgl-engine.shaders.LineMarkerTechnique")],A);class l extends Ae{constructor(e){super(),this.spherical=e,this.space=1,this.anchor=0,this.occluder=!1,this.writeDepth=!1,this.hideOnShortSegments=!1,this.hasCap=!1,this.hasTip=!1,this.hasVVSize=!1,this.hasVVColor=!1,this.hasVVOpacity=!1,this.hasOccludees=!1,this.terrainDepthTest=!1,this.cullAboveTerrain=!1,this.hasScreenSizePerspective=!1,this.textureCoordinateType=0,this.emissionSource=0,this.discardInvisibleFragments=!0,this.occlusionPass=!1,this.hasVVInstancing=!1,this.hasSliceTranslatedView=!0,this.olidColorInstanced=!1,this.overlayEnabled=!1,this.snowCover=!1}get draped(){return this.space===0}get worldSpace(){return this.space===2}}c([d({count:3})],l.prototype,"space",void 0),c([d({count:2})],l.prototype,"anchor",void 0),c([d()],l.prototype,"occluder",void 0),c([d()],l.prototype,"writeDepth",void 0),c([d()],l.prototype,"hideOnShortSegments",void 0),c([d()],l.prototype,"hasCap",void 0),c([d()],l.prototype,"hasTip",void 0),c([d()],l.prototype,"hasVVSize",void 0),c([d()],l.prototype,"hasVVColor",void 0),c([d()],l.prototype,"hasVVOpacity",void 0),c([d()],l.prototype,"hasOccludees",void 0),c([d()],l.prototype,"terrainDepthTest",void 0),c([d()],l.prototype,"cullAboveTerrain",void 0),c([d()],l.prototype,"hasScreenSizePerspective",void 0);class Xe extends Fe{constructor(e,r){super(e,Ke),this.produces=new Map([[2,i=>i===8||k(i)&&this.parameters.renderOccluded===8],[3,i=>je(i)],[11,i=>K(i)&&this.parameters.renderOccluded===8],[12,i=>K(i)&&this.parameters.renderOccluded===8],[4,i=>k(i)&&this.parameters.writeDepth],[9,i=>k(i)&&!this.parameters.writeDepth],[20,i=>k(i)||i===8]]),this.intersectDraped=void 0,this._configuration=new l(r)}getConfiguration(e,r){return super.getConfiguration(e,r,this._configuration),this._configuration.space=r.slot===20?0:this.parameters.worldSpace?2:1,this._configuration.hideOnShortSegments=this.parameters.hideOnShortSegments,this._configuration.hasCap=this.parameters.cap!==0,this._configuration.anchor=this.parameters.anchor,this._configuration.hasTip=this.parameters.hasTip,this._configuration.hasSlicePlane=this.parameters.hasSlicePlane,this._configuration.hasOccludees=r.hasOccludees,this._configuration.writeDepth=this.parameters.writeDepth,this._configuration.hasVVSize=this.parameters.hasVVSize,this._configuration.hasVVColor=this.parameters.hasVVColor,this._configuration.hasVVOpacity=this.parameters.hasVVOpacity,this._configuration.occluder=this.parameters.renderOccluded===8,this._configuration.terrainDepthTest=r.terrainDepthTest&&k(e),this._configuration.cullAboveTerrain=r.cullAboveTerrain,this._configuration.hasScreenSizePerspective=this.parameters.screenSizePerspective!=null,this._configuration}get visible(){return this.parameters.color[3]>=Ie}intersect(){}createBufferWriter(){return new Ye(Q(this.parameters),this.parameters)}createGLMaterial(e){return new He(e)}}class He extends Ee{dispose(){super.dispose(),this._markerTextures?.release(this._markerPrimitive),this._markerPrimitive=null}beginSlot(e){const r=this._material.parameters.markerPrimitive;return r!==this._markerPrimitive&&(this._material.setParameters({markerTexture:this._markerTextures.swap(r,this._markerPrimitive)}),this._markerPrimitive=r),this.getTechnique(A,e)}}class Ke extends Ne{constructor(){super(...arguments),this.width=0,this.color=[1,1,1,1],this.markerPrimitive="arrow",this.placement="end",this.cap=0,this.anchor=0,this.hasTip=!1,this.worldSpace=!1,this.hideOnShortSegments=!1,this.writeDepth=!0,this.hasSlicePlane=!1,this.vvFastUpdate=!1,this.stipplePattern=null,this.markerTexture=null}}class Ye{constructor(e,r){this.layout=e,this._parameters=r}elementCount(){return this._parameters.placement==="begin-end"?12:6}write(e,r,i,P,x,u){const g=i.get("position").data,a=g.length/3;let S=[1,0,0];const y=i.get("normal");this._parameters.worldSpace&&y!=null&&(S=y.data);let h=1,p=0;this._parameters.vvSize?p=i.get("sizeFeatureAttribute").data[0]:i.has("size")&&(h=i.get("size").data[0]);let $=[1,1,1,1],F=0;this._parameters.vvColor?F=i.get("colorFeatureAttribute").data[0]:i.has("color")&&($=i.get("color").data);let j=0;this._parameters.vvOpacity&&(j=i.get("opacityFeatureAttribute").data[0]);const z=new Float32Array(x.buffer),w=Re(x.buffer),V=new Uint8Array(x.buffer);let v=u*(this.layout.stride/4);const b=z.BYTES_PER_ELEMENT/w.BYTES_PER_ELEMENT,X=4/b,T=(n,D,m,f)=>{z[v++]=n[0],z[v++]=n[1],z[v++]=n[2],Be(D,n,w,v*b),v+=X;let s=v*b;if(w[s++]=m[0],w[s++]=m[1],v=Math.ceil(s/b),this._parameters.vvColor)z[v++]=F;else{const W=Math.min(4*f,$.length-4),C=4*v++;V[C]=255*$[W],V[C+1]=255*$[W+1],V[C+2]=255*$[W+2],V[C+3]=255*$[W+3]}this._parameters.vvOpacity&&(z[v++]=j),s=v*b,this._parameters.vvSize?(z[v++]=p,s+=2):w[s++]=h,this._parameters.worldSpace&&(w[s++]=S[0],w[s++]=S[1],w[s++]=S[2]),v=Math.ceil(s/b)},I=(n,D)=>{const m=Y(Ge,g[3*n],g[3*n+1],g[3*n+2]),f=Je;let s=n+D;do Y(f,g[3*s],g[3*s+1],g[3*s+2]),s+=D;while(Ue(m,f)&&s>=0&&s<a);e&&(G(m,m,e),G(f,f,e)),T(m,f,[-1,-1],n),T(m,f,[1,-1],n),T(m,f,[1,1],n),T(m,f,[-1,-1],n),T(m,f,[1,1],n),T(m,f,[-1,1],n)},O=this._parameters.placement;return O!=="begin"&&O!=="begin-end"||I(0,1),O!=="end"&&O!=="begin-end"||I(a-1,-1),null}}const Ge=J(),Je=J(),Ze=Object.freeze(Object.defineProperty({__proto__:null,build:Z},Symbol.toStringTag,{value:"Module"}));export{Xe as g};
