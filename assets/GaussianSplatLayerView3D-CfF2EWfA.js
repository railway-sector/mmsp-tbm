...
}`)}let Ci=class extends Te{constructor(){super(...arguments),this.tileCameraPosition=k(),this.cameraDelta=k()}};function Ti(i){i.code.add(_`vec4 unpackColor(uvec4 packedGaussian) {
vec4 color;
