import{kJ as Pe,n2 as be,q3 as we,F0 as f,pU as w,p_ as Ve,pN as W,IJ as r,FV as U,GI as Y,BM as De,pR as C,oN as ee,j8 as R,jQ as B,q4 as xe,Cb as te,F7 as ie,pP as M,bt as m,AP as v,Nu as ne,A0 as se,yT as o,B2 as ae,hM as Ee,vm as ye,fx as Le,lT as re,z9 as le,KZ as Se,IR as Ce,u7 as Me,IP as Ae,pV as $e,Ae as H,oQ as Re,rZ as oe,IK as ce,jA as he,mk as Te,E6 as G,K_ as q,jx as c,lK as z,HP as de,fZ as pe,oE as Ie,Jv as I,je as Oe,F3 as qe,Ee as je,kL as Ue,uu as D,kK as ze,s0 as k,Fc as Ne,Ei as Fe,D6 as T,BO as We,xV as Be,Lb as He,f8 as Ge,Ce as ke,l8 as Ke,tv as Ze,jC as A,ly as Je,I4 as K}from"./index-t9xTnnrs.js";import{t as Qe}from"./VisualElement-6d7U3IwP.js";function ue(t,e){const n=t.fragment;n.include(Pe),t.include(be),n.include(we),n.uniforms.add(new f("globalAlpha",i=>i.globalAlpha),new w("glowColor",i=>i.glowColor),new f("glowWidth",(i,s)=>i.glowWidth*s.camera.pixelRatio),new f("glowFalloff",i=>i.glowFalloff),new w("innerColor",i=>i.innerColor),new f("innerWidth",(i,s)=>i.innerWidth*s.camera.pixelRatio),new Ve("depthMap",i=>i.depth?.attachment),new W("normalMap",i=>i.normals)),n.code.add(r`vec4 premultipliedColor(vec3 rgb, float alpha) {
...
}`)}const N=U(6);function fe(t){const e=new Y;e.include(De),e.include(ue,t);const n=e.fragment;if(t.lineVerticalPlaneEnabled||t.heightManifoldEnabled)if(n.uniforms.add(new f("maxPixelDistance",(i,s)=>t.heightManifoldEnabled?2*s.camera.computeScreenPixelSizeAt(i.heightManifoldTarget):2*s.camera.computeScreenPixelSizeAt(i.lineVerticalPlaneSegment.origin))),n.code.add(r`float planeDistancePixels(vec4 plane, vec3 pos) {
float dist = dot(plane.xyz, pos) + plane.w;
float width = fwidth(dist);
dist /= min(width, maxPixelDistance);
return abs(dist);
}`),t.spherical){const i=(a,l,p)=>m(a,l.heightManifoldTarget,p.camera.viewMatrix),s=(a,l)=>m(a,[0,0,0],l.camera.viewMatrix);n.uniforms.add(new C("heightManifoldOrigin",(a,l)=>(i(u,a,l),s(V,l),ee(V,V,u),R(d,V),d[3]=B(V),d)),new xe("globalOrigin",a=>s(u,a)),new f("cosSphericalAngleThreshold",(a,l)=>1-Math.max(2,te(l.camera.eye,a.heightManifoldTarget)*l.camera.perRenderPixelRatio)/B(a.heightManifoldTarget))),n.code.add(r`float globeDistancePixels(float posInGlobalOriginLength) {
